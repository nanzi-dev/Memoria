...
export default function ChatRoom() {
  ...
  }, [input, sending, sendingMulti, view, singleSessionId, multiSessionId, multiSessionStatus, groupName, affinity, trust, character, participants, allChars, PLAYER_ID, PLAYER_NAME, syncGroupHistory]);
        ...
        <div ref={messageScrollRef} style={{ overflowAnchor: 'none' }} className="relative flex-1 min-h-0 overflow-y-auto px-2.5 sm:px-4 py-3 space-y-3" onScroll={(e) => {
          ...
          {messages.flatMap((msg, i) => {
            ...
            return replyBubbles.map((bubble, bubbleIndex) => {
              ...
              <div key={`${msg.message_id ?? msg.client_id ?? i}-${bubbleIndex}`} className={`animate-fade-up flex gap-2.5 ${isUser ? 'flex-row-reverse' : ''}`}>
